  ...
  djs: {
    ...
    warehouse: {
      ...
      packEntry: {
        ...
        measureDeviationTitle: 'Weight deviation out of tolerance',
        measureDeviationTip: 'Packing rule {rule}kg, current weight {actual}kg (tolerance ±{tolerance}%)',
        measureDeviationConfirm: 'Actual {actual}kg deviates from the {rule}kg packing rule by more than {tolerance}%. Continue packing?',
