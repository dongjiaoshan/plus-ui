export default {
  ...
  store: {
    ...
    column: {
      ...
      productionMarkCode: 'Production mark',
      managerName: 'Manager',
    ...
    placeholder: {
      ...
      productionMarkCode: 'Enter production mark code',
  ...
  pig: {
    ...
    toFatten: {
      action: 'To Fattening',
      title: 'Convert to Fattening Pig',
      transferDate: 'Transfer Date',
      transferDatePlaceholder: 'Select transfer date',
      transferDateRequired: 'Transfer date is required',
      operator: 'Transfer Owner',
      operatorPlaceholder: 'Select transfer owner',
      operatorRequired: 'Transfer owner is required',
      newBarn: 'Target Barn',
      newBarnPlaceholder: 'Select target barn',
      newBarnRequired: 'Target barn is required',
      newPen: 'Target Pen',
  ...
  product: {
    ...
    field: {
      ...
      isMaterialSold: 'Raw Material Resale',
      storeLocation: 'Store Location',
      updateBy: 'Updated By',
      supplierId: 'Supplier',
  ...
  plantCrop: {
    ...
    placeholder: {
      ...
      cropGenus: 'Enter genus (e.g. Brassica)',
  ...
  djs: {
    ...
    warehouse: {
      ...
      packEntry: {
        ...
        selectProductFirst: 'Select a product, then choose a demand store',
        copiesUnit: '',
        ...
        outputWeightLabel: 'White Bar Inbound Weight',
        ...
        vegWeightExceed: 'Pack weight exceeds requisition remaining weight ({remain}g), please re-weigh',
      ...
      check: {
        ...
        checkedProductCount: 'Checked Products',
        abnormalCount: 'Product Abnormal',
        diffSum: 'Net Diff',
        createTime: 'Recorded At',
        detail: 'Detail',
        complete: 'Complete',
        cancel: 'Cancel',
      ...
      production: {
        ...
        column: {
          ...
          isDeliveryCheck: 'Is Checked',
          isArrivalConfirm: 'Is Arrived',
  ...
  warehouse: {
    dashboard: {
      ...
      returnTabKg: 'Bulk Products',
      returnTabNonKg: 'Packaged Products',
      demandTabPork: 'Pork',
      demandTabVeg: 'Vegetable',
      demandTabKg: 'Bulk Products',
      demandTabNonKg: 'Packaged Products',
      otherSlice: 'Other',
      seriesWhiteBarHead: 'White-bar Heads',
      seriesPorkWeight: 'Pork Product Weight',
      seriesVegWeight: 'Veg Product Weight',
      seriesPorkLoss: 'Pork Loss',
      seriesVegLoss: 'Veg Loss',
      unitHead: 'head',
      unitKg: 'kg',
      unitKind: 'kinds',
      unitPiece: 'pcs',
      ...
      chartLossTrend: 'Loss Trend (last 7 days)',
  ...
  storeTrace: {
    ...
    pork: {
      ...
      materialRemain: 'Material left',
      materialOverWeight: 'Pack weight exceeds today\'s remaining packable amount of material "{material}" ({remain}g left)',
      materialNoInbound: 'Store stocktake has no inbound quantity for material "{material}" today — record it in store stocktake first',
      pickCut: 'Select Cut',
      opPanel: 'Operation',
      pigId: 'Pig ID',
      pigSex: 'Sex',
