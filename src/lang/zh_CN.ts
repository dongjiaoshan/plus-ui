  ...
  djs: {
    ...
    warehouse: {
      ...
      packEntry: {
        ...
        cannotSubmit: '无法提交',
        measureDeviationTitle: '重量偏差超出容差范围',
        measureDeviationTip: '打包规则 {rule}kg，当前称重 {actual}kg（允许偏差 ±{tolerance}%）',
        measureDeviationConfirm: '实称 {actual}kg 与打包规则 {rule}kg 偏差超过 {tolerance}%，确认继续打包？',
