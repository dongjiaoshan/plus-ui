  ...
  djs: {
    ...
    warehouse: {
      ...
      packEntry: {
        ...
        measureBelowTip: '打包规则 {rule}kg，当前称重 {actual}kg，不能少于规则重量，请重新称重',
        measureDeviationTitle: '称重超出打包规则',
        measureDeviationTip: '打包规则 {rule}kg，当前称重 {actual}kg（超出 {tolerance}% 仍可确认提交）',
        measureDeviationConfirm: '实称 {actual}kg 比打包规则 {rule}kg 超出 {tolerance}%，确认继续打包？',
