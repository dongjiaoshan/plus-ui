<template>
  <div class="p-2">
    ...
    <DemandForm ref="formRef" product-type="gift_box" @success="fetchList" />
    <DemandCart ref="cartRef" product-type="gift_box" @success="fetchList" />
    <HistoryDialog ref="historyDialogRef" />
  </div>
</template>

<script setup name="DemandGiftBox" lang="ts">
...
const columns = computed<BizTableColumn[]>(() => [
  ...
  { prop: 'productName', label: t('demand.column.giftSku'), minWidth: 160, showOverflowTooltip: true },
