<template>
  <div class="p-2">
    ...
    <DemandForm ref="formRef" product-type="other" @success="fetchList" />
    <DemandCart ref="cartRef" product-type="other" @success="fetchList" />
    <HistoryDialog ref="historyDialogRef" />
  </div>
</template>

<script setup name="DemandOther" lang="ts">
