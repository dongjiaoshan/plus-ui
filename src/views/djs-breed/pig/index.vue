...
const columns: BizTableColumn[] = [
  ...
  { prop: 'pigBreedName', label: t('pig.column.pigBreedCode'), width: 110, align: 'center' },
  { prop: 'pigStrainName', label: t('pig.column.pigStrainCode'), width: 110, align: 'center' },
  { prop: 'birthDate', label: t('pig.column.birthDate'), width: 110, align: 'center', formatter: 'date' },
  { prop: 'barnName', label: t('pig.column.barn'), width: 90, align: 'center' },
  { prop: 'penName', label: t('pig.column.pen'), width: 90, align: 'center' },
