 ...
 *
 * 列：耳号 / 性别 / 出生日期 / 入栏日期(status_started_at) / 当前状态 / 栋舍 / 栏位 / 备注
 *
...
const columns: BizTableColumn[] = [
  ...
  { prop: 'statusStartedAt', label: t('pig.column.enterFattenAt'), width: 160, align: 'center', formatter: 'datetime' },
  ...
  { prop: 'fatherEar', label: t('pig.column.fatherEar'), width: 130, align: 'center', visible: false },
  { prop: 'motherEar', label: t('pig.column.motherEar'), width: 130, align: 'center', visible: false },
